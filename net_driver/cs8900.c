 ...
 *
 *	  05-June-2011 Modified for reille2440(guoyirong)
 */

#define VERSION_STRING "Cirrus Logic CS8900A driver for Linux (Modified for reille2440)"
/*
...
#include <linux/pm.h>
#include <asm/irq.h>
//#include <asm/hardware.h>	// del by guoyirong 2011.6.4
#include <asm/io.h>
...
#if defined(CONFIG_ARCH_UTU2440)
...
// added by guoyirong 2011.6.4
//#if defined(CONFIG_ARCH_REILLE2440)
...
{
 //       init: cs8900_probe		// del by guoyirong 2011.6.4
};
*/
...
#if defined(CONFIG_ARCH_SMDK2410)|defined(CONFIG_ARCH_UTU2440)|defined(CONFIG_ARCH_REILLE2440)
...
int __init cs8900_probe (struct net_device *dev)
{
	...
	ether_setup (dev);		// init some net_device member value
...
//	SET_MODULE_OWNER (dev);		// del by guoyirong 2011.6.5
